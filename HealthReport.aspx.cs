        ...
        try
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                if (objRes.res == true && objRes.DS.Tables[0].Rows.Count > 0)
                {
                    ...
                    int ColTot = objRes.DS.Tables[0].Columns.Count;

                    HttpContext.Current.Response.Write("<Table border='2' bgColor='#ffffff' " +
                            "borderColor='#000000' Text-align='Center' cellSpacing='0' cellPadding='0' " + "style='font-size:10.0pt; font-family:Arial, Helvetica, sans-serif; background:white'> " +
                    ...
                    dg.DataSource = objRes.DS;
                    dg.DataBind();
                    dg.HeaderStyle.ForeColor = Color.White;
                    dg.HeaderStyle.BackColor = Color.Blue;
                    dg.HeaderStyle.Font.Bold = true;
                    dg.Font.Name = "Calibri";
                    dg.RenderControl(htw);
                    Response.Write(stringWriter.ToString() + "</Table>");
