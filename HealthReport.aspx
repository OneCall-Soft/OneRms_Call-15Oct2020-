<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HealthReport.aspx.cs" Inherits="Health" %>
     ...
     <header id="topbar" class="alt">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-current-item">Health Report</li>
            </ol>
        </div>
    </header>
                ...
                <div class="box-header with-border  ">
                    <div class="row" runat="server" id="searchingOption">
                        ...
                        <div class="col-md-2">
                            ...
                            <asp:Button ID="btnExport" runat="server" Text="Export All LHO Records" class="btn btn-flat btn-success form-control" OnClick="btnExport_Click" />
                        </div>
